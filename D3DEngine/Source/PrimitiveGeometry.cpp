...
void PrimitiveGeometry::Draw(ID3D11DeviceContext* pDeviceContext) {
...
std::unique_ptr<PrimitiveGeometry> PrimitiveGeometry::CreateSphere(ID3D11DeviceContext* pDeviceContext, float diameter, size_t tessellation, bool rhcoords) {
	...
	std::unique_ptr<PrimitiveGeometry> mesh(new PrimitiveGeometry());
...
std::unique_ptr<PrimitiveGeometry> PrimitiveGeometry::CreateCube(ID3D11DeviceContext* deviceContext, float size, bool rhcoords) {
...
std::unique_ptr<PrimitiveGeometry> PrimitiveGeometry::CreateCone(ID3D11DeviceContext* deviceContext, float diameter, float height, size_t tessellation, bool rhcoords) {
	VertexCollection vertices;
	IndexCollection indices;
...
std::unique_ptr<PrimitiveGeometry> PrimitiveGeometry::CreateTorus(_In_ ID3D11DeviceContext* deviceContext, float diameter, float thickness, size_t tessellation, bool rhcoords) {
	VertexCollection vertices;
	IndexCollection indices;
...
void PrimitiveGeometry::Initialize(ID3D11DeviceContext* deviceContext, VertexCollection& vertices, IndexCollection& indices, bool rhcoords) {
